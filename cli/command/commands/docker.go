...
import (
	...
	"github.com/docker/cli/cli/command/daemon"
...
func NewDockerCommand(dockerCli *command.DockerCli, addCommands func(Command, *command.DockerCli)) *cobra.Command {
	...
	cmd.AddCommand(daemon.NewDaemonCommand())
