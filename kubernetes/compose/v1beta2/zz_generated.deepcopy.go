...
func (x *ComposeFile) DeepCopyObject() runtime.Object {
...
func (in *ComposeFile) DeepCopyInto(out *ComposeFile) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, creating a new ComposeFile.
func (x *ComposeFile) DeepCopy() *ComposeFile {
	if x == nil {
		return nil
	}
	out := new(ComposeFile)
...
func deepCopyService(in, out *types.ServiceConfig) {
	j, _ := json.Marshal(*in)
...
func (in *Scale) DeepCopyInto(out *Scale) {
	*out = *in
	if in.Spec != nil {
		out.Spec = make(map[string]int)
		for k,v := range(in.Spec) {
			out.Spec[k] = v
		}
	}
	if in.Status != nil {
		out.Status = make(map[string]int)
