...
type StackInterface interface {
	...
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Stack, err error)
	StackExpansion
}
...
func (c *stacks) Create(stack *v1beta2.Stack) (result *v1beta2.Stack, err error) {
...
func (c *stacks) Update(stack *v1beta2.Stack) (result *v1beta2.Stack, err error) {
	result = &v1beta2.Stack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) UpdateStatus(stack *v1beta2.Stack) (result *v1beta2.Stack, err error) {
	result = &v1beta2.Stack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) Get(name string, options v1.GetOptions) (result *v1beta2.Stack, err error) {
	result = &v1beta2.Stack{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) List(opts v1.ListOptions) (result *v1beta2.StackList, err error) {
...
func (c *stacks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Stack, err error) {
	result = &v1beta2.Stack{}
